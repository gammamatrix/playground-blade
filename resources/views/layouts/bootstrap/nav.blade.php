<nav class="navbar navbar-expand-sm bg-body-tertiary">
    <div class="container-fluid">
        <a
            class="navbar-brand"
            href="{!! __(config("playground-blade.app.url")) !!}"
        >
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        @if (Route::has("theme"))
                            ...
                            <li>
                                <p class="ms-3 my-1 text-info">Themes</p>
                            </li>
                            @php
                            ...
                            @if (Route::has("theme"))
                                @foreach (Playground\Blade\Facades\Ui::themes() as $themeKey => $_theme)
                                    ...
                                    <li>
                                        <a
                                            class="dropdown-item{{ (empty($selectedTheme) && "default" === $themeKey) || $selectedTheme === $themeKey ? " active" : "" }}"
