 ...
 */
$withTable =
    isset($withTable) && (is_bool($withTable) || is_string($withTable))
        ? $withTable
        : true;
...
if (! ($packageInfo instanceof \Playground\PackageInfo)) {
    throw new RuntimeException(
        "Expecting package info for resources/views/layouts/resource/index.blade.php",
        500,
    );
}
 ...
 */
$withTableColumns =
    isset($withTableColumns) &&
    is_array($withTableColumns) &&
    ! empty($withTableColumns)
        ? $withTableColumns
        : [];
        ...
        <div class="row justify-content-center">
            @if ($withCreate)
                <div class="col-md-12 mb-3">
                    <div
                        class="btn-group float-end px-3"
                        role="group"
