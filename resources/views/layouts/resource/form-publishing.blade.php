    ...
    <div class="row">
        <div class="col">
            <div class="form-check form-check-inline">
                ...
                <input class="form-check-input" type="checkbox" id="form-input-published" name="published" value="1"
        ...
        <div class="col">
            <div class="form-check form-check-inline">
                ...
                <input class="form-check-input" type="checkbox" id="form-input-released" name="released" value="1"
