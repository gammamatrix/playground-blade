<div>
    ...
    <div class="float-end">
        ...
        <button class="btn btn-warning btn-toggler text-nowrap py-1" type="button" data-bs-toggle="collapse"
                data-bs-target="#{{$id}} div.data-form" aria-expanded="true" aria-controls="{{$id}} div.data-form">
