    ...
    <legend>
        <div class="float-end">
            ...
            <button class="btn btn-warning btn-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#{{$id}}-fieldset-filter-flags .container" aria-expanded="true"
                    aria-controls="{{$id}}-fieldset-filter-flags .container">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="input-group mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" aria-label="" id="form_filter_{{$column}}"
                                   name="filter[{{$column}}]" value="1" {{$hasValidated ? 'checked' : ''}}>
